module FHIR
  class HumanName < FHIR::Model
    ...
    METADATA = {
      ...
      'use' => {'valid_codes'=>{'http://hl7.org/fhir/name-use'=>['usual', 'official', 'temp', 'nickname', 'anonymous', 'old', 'maiden', 'usual', 'official', 'temp', 'nickname', 'anonymous', 'old']}, 'type'=>'code', 'path'=>'HumanName.use', 'min'=>0, 'max'=>1, 'binding'=>{'strength'=>'required', 'uri'=>'http://hl7.org/fhir/ValueSet/name-use'}},
